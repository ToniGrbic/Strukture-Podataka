...
int IspisiPolinom(listPoli P, char *imePoli);
...
int main(){
 ...
 IspisiPolinom(Pol1.next, "Pol1");
 IspisiPolinom(Pol2.next, "Pol2");
 
 ZbrojDvaPolinoma(&zbrojPol, &Pol1, &Pol2);
 IspisiPolinom(zbrojPol.next, "Pol1+Pol2");
 
 UmnozakDvaPolinoma(&umnozakPol, &Pol1, &Pol2);
 IspisiPolinom(umnozakPol.next, "Pol1*Pol2");
